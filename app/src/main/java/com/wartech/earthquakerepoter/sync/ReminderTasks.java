...
import com.wartech.earthquakerepoter.Earthquake;
import com.wartech.earthquakerepoter.UserLocation;
import com.wartech.earthquakerepoter.utilities.NotificationUtils;
        ...
        if (ACTION_EARTHQUAKE_REMINDER.equals(action)) {
            ...
            if (networkInfo != null && networkInfo.isConnected() && gps_enabled) {
                ...
                if (distance <= earthquakeRange) {
                    ...
                    Log.d("Notification", "Earthquake distance: " + distance);
                }
            }
